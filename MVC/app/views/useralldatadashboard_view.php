            ...
            <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white rounded-lg p-6 shadow-sm">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-gray-500 text-sm">Total delivery</h3>
                ...
                <div class="bg-white rounded-lg p-6 shadow-sm">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-gray-500 text-sm">Total Payment</h3>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: '/Ecommerce/MVC/count_user_data/', // Update the URL to match your route
            method: 'GET',
            dataType: 'json',
            success: function(response) {
                if (response.total !== undefined) {
...
$(document).ready(function() {
    // Fetch recent orders
    $.ajax({
        url: '/Ecommerce/MVC/count_user_data/getRecentOrders',
        type: 'GET',
        dataType: 'json',
